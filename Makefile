...
WORKSPACE_DIR?=$(AGENTX_HOME)/workspace
...
## build: Build the agentx binary for current platform
build: generate
...
## build-all: Build agentx for all platforms
build-all: generate
...
## install: Install agentx to system and copy builtin skills
install: build
...
## uninstall: Remove agentx from system
uninstall:
...
## uninstall-all: Remove agentx and all data
uninstall-all:
	@echo "Removing workspace and skills..."
	@rm -rf $(AGENTX_HOME)
	@echo "Removed workspace: $(AGENTX_HOME)"
...
help:
	...
	@echo "  WORKSPACE_DIR           # Workspace directory (default: ~/.agentx/workspace)"
