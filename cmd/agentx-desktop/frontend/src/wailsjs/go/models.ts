export namespace config {
	...
	export class ImageProviderConfig {
	    api_key: string;
	    model?: string;
	    api_base?: string;
	
	    static createFrom(source: any = {}) {
	        return new ImageProviderConfig(source);
	    }
	...
	export class ImageToolsConfig {
	    providers?: Record<string, ImageProviderConfig>;
	
	    static createFrom(source: any = {}) {
	        return new ImageToolsConfig(source);
	    }
	
	    constructor(source: any = {}) {
	        if ('string' === typeof source) source = JSON.parse(source);
	        this.providers = this.convertValues(source["providers"], ImageProviderConfig, true);
	    }
	...
	export class ToolsConfig {
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.image = this.convertValues(source["image"], ImageToolsConfig);
	    }
